...
tahun_terpilih = col1.multiselect("📅 Pilih Tahun", sorted(df["Tahun"].unique()), default=sorted(df["Tahun"].unique()))
kategori_terpilih = col2.multiselect("🏷️ Pilih Kategori", df["Kategori"].unique(), default=list(df["Kategori"].unique()))
bulan_terpilih = col3.multiselect("🗓️ Pilih Bulan", df["Bulan"].unique(), default=list(df["Bulan"].unique()))
